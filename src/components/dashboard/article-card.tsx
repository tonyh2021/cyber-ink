    ...
    <>
      ...
      >
        ...
        <button
          ...
          className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 p-1.5 rounded-standard bg-surface-card/80 text-text-muted hover:text-danger transition-opacity"
